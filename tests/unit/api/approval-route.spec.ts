/**
 * Testes da rota pública de aceite (T045):
 * POST /approval. O client Supabase é mockado; os testes garantem o
 * mapeamento dos códigos da RPC para os status HTTP do contrato e a
 * forma do recibo público (camelCase).
 */
...
function mockRpc(
  result: { ok: boolean; code?: string; receipt?: unknown } | null,
  error: unknown = null,
) {
